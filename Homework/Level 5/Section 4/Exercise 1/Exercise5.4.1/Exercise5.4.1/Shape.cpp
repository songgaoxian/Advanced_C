...
//implement Shape
Shape::Shape() { std::cout << "a shape created by default\n"; }
Shape::Shape(const Shape& shp) { std::cout << "a shape created by copy\n"; }
...
Shape* Point::Clone() { return new Point(*this); }
//end
...
bool Line::isShapeComposite() { return false; }
...
bool Circle::isShapeComposite() { return false; }
Shape* Circle::Clone() { return new Circle(*this); }
//end